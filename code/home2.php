...
function slideShow() {
    ...
    //Call the gallery function to run the slideshow, 6000 = change to next image after 4 seconds
...
<tr><td align="center" width="90%" height="10"><p style="font-family: 'Josefin Sans Std Light', serif;font-weight:bold;font-style:normal; "><font color="#990000" font-size="15px"><marquee width="90%" height="10" scrollamount="2" scrolldelay="2" behaviour="scroll" direction="left" >Sankalp2010 website is launched officialy, Online Registrations have started,Problem Statement of Robotics and Electronic Hardware Modelling has been updated. </marquee></font></p></td></tr></table></td></tr>
<!-- marquee path -->
<tr><td align="center" style="padding-top:3px;">    
<table width="85%" cellspacing="2px" cellpadding="1px">
...
<tr><td>
<table width="100%" align="center">
<tr id="cont"><td width="100%" align="center">
<div id="gallery" >

    <a href="#" class="show">
        <img src="http://www.sankalp2010.com/photos/ind1.jpg" alt="" width="852" height="284" title="" alt="" rel="<h3>Indian ocean band</h3> "/>
    </a>
    
    <a href="#">
        <img src="http://www.sankalp2010.com/photos/ind2.jpg" alt="" width="852" height="284" title="" alt="" rel="<h3>Indian ocean band</h3>"/>
    </a>
    
    <a href="#">
        <img src="http://www.sankalp2010.com/photos/nms.jpg"  alt="" width="852" height="284" title="" alt="" rel="<h3>nms</h3>"/>
    </a>
...
<script src="http://cdn.wibiya.com/Toolbars/dir_0566/Toolbar_566436/Loader_566436.js" type="text/javascript"></script>
</body>
</html>