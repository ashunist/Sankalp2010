...
<body>
<div style="font-family: 'Josefin Sans Std Light', serif;font-weight:bold;font-style:normal; ">
<font color="#FFFFFF" >
<form name="regevent" action="register_events.php" method="POST" onSubmit="return checkckbox()">
<fieldset>
<legend>Register Events</legend>
<table align="center" width="100%">
<tr>
<td><B>TECHNOCRACY EVENTS:</B></td></tr>
<tr>
...
<tr>
<td><input type="checkbox" name="event21" value="Terpischore" />Terpischore</td>
<td><input type="checkbox" name="event22" value="Dezbatare" />Dezbatare</td>
</tr>
<tr><td>RECREATIONAL EVENTS:</td></tr>
<tr>
<td><input type="checkbox" name="event23" value="Resturi de Reciclare " />Resturi de Reciclare (Junk Sense)</td>
<td><input type="checkbox" name="event24" value="Dominus de Computers " />Dominus de Computers (King Of Computers)</td>
<td><input type="checkbox" name="event25" value="Conuero per Tresoro" />Conquero per Tresoro(Treasure Hunt)</td>
<td><input type="checkbox" name="event26" value="Fotogenic" />Fotogenic(Photogenic) </td>
</tr>
<tr>
